...
@section('script')
<script>
    $('.iq-edit-list ul li a').removeClass('active')
    $('.iq-edit-list ul li a').eq({!! $active_tab; !!}).addClass('active')

    $('.iq-edit-list-data .tab-pane.fade').removeClass('active')
    $('.iq-edit-list-data .tab-pane.fade').removeClass('show')

    $('.iq-edit-list-data .tab-pane.fade').eq({!! $active_tab; !!}).addClass('active')
    $('.iq-edit-list-data .tab-pane.fade').eq({!! $active_tab; !!}).addClass('show')
</script>
@endsection